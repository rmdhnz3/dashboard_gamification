                  ...
                  return (
                    <tbody key={item.id}>
                      <tr className="bg-white border-b font-medium dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100" >
                        ...
                        /></Card></td>
                        <td>
                          {item.status == 1 ? <td><span className="text-md inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-green-500 text-white rounded">Available</span></td> : <td><span className="text-md inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-red-500 text-white rounded">Unavailable</span></td>}
                        </td>
                        <td>
                          <tr>
                            <td>
          ...
          <DialogContent style={{ width: 560 }} dividers={scroll === 'paper'}>
            <DialogContentText
              ...
              <Typography id="modal-modal-content" variant="h6" component="h2" style={{ paddingBottom: "20px" }}>
                ...
                <tr>
                  <td>Created At :</td>
                  <td>{moment(detail.badges.created_at, 'YYYY-MM-DDTHH:mm:ssZ').format().slice(0, 10)} </td>
                </tr>

                <tr>
                  <td>Updated At :</td>
                  <td>{moment(detail.badges.updated_at, 'YYYY-MM-DDTHH:mm:ssZ').format().slice(0, 10)} </td>
                </tr>

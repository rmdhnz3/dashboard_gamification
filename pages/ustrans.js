...
import { Dialog, DialogContent, DialogTitle, DialogContentText, DialogActions, Input, Select, MenuItem } from "@mui/material";
...
export default function User() {
  ...
  const ustransUpdate = [state.point_change, state.status]
  console.log(ustransUpdate)
  ...
  const handleOpenUstransDetail = () => {
    setOpen({
      Ustrans1: true
    })
  }
  const handleCloseUstransDetail = () => {
    setOpen({
      Ustrans1: false
    })
  }
  const handleOpenUstransUpdate = () => {
    setOpen({
      Ustrans2: true
    })
  }
  const handleCloseUstransUpdate = () => {
    setOpen({
      Ustrans2: false
    })
  }
  const handleOpenUstransDelete = () => {
    setOpen({
      Ustrans3: true
    })
  }
  const handleCloseUstransDelete = () => {
    setOpen({
      Ustrans3: false
    })
  }
  ...
  return (
    <div className='container mx-auto px-10 mt-8 mb-8 py-4'>
      ...
      <div>
        ...
        <Dialog
          open={open.Ustrans2}
          onClose={handleCloseUstransUpdate}
              ...
              <Typography id="modal-modal-content" variant="h6" component="h2" style={{ paddingBottom: "20px" }}>
                ...
                <tr>
                  ...
                  <td><Input
                    ...
                    type="text"
                    placeholder={detail.ustrans.point_change}
                    name="point_change"
                    value={state.point_change}
                ...
                <tr>
                  ...
                  <td>
                    <Select
                      ...
                      style={{ marginTop: 20 }}
                    >
                      <MenuItem value={1} name="status"><td><span className="text-md inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-green-500 text-white rounded">Masuk</span></td></MenuItem>
                      <MenuItem value={0} name="status"><td><span className="text-md inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-red-500 text-white rounded">Keluar</span></td></MenuItem>
                    </Select>
                  </td>
                </tr>
                <tr>
